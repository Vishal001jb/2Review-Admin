...
{
    [Activity(Label = "AddEmployee",Theme = "@style/Theme.AppCompat.Light", ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation, ScreenOrientation = ScreenOrientation.Portrait)]

    public class AddEmployee : AppCompatActivity
    {
        AzureDataService dataService = new AzureDataService();
        TextView textviewjoiningdate;
        EditText edittextuserfname, edittextusermname, edittextuserlname, edittextusernumber, edittextuseremail, edittextuseraddress, edittextusercity, edittextuserpincode, edittextuserstate, edittextusercountry, edittextusername, edittextuserpassword, edittextconfirmpassword;
